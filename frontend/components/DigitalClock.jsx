...
const DIGITAL = {
  ...
  minimal: "bg-red-50 border-slate-200 text-slate-900",
  neon: "bg-slate-900 border-slate-800 text-cyan-200",
  sunset:
    "bg-gradient-to-b from-orange-50 to-rose-100 border-rose-200 text-slate-900",
  matrix: "bg-slate-950 border-slate-800 text-emerald-300",
  glass: "bg-blue-100 border-brown/30 backdrop-blur text-purple-900",
  royal:
    "bg-gradient-to-b from-indigo-600 to-indigo-800 border-indigo-500 text-amber-200",
};
  ...
  return (
    ...
    >
      <div className="text-3xl font-mono tracking-tight">
        {dt.toFormat(seconds ? "HH:mm:ss" : "HH:mm")}
      </div>
